# Дипломный проект. Задание 1: Юнит-тесты для Stellar Burgers

<hr>


**Студент: Ольга Песоцкая** 
...
## Описание
Первое задание дипломного проекта по курсу "Инженер по тестированию: от новичка до автоматизатора" в Яндекс Практикуме.
